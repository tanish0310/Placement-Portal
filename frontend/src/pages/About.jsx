...
const About = () => {
  return (
    <section className="about-section">
      <h1 className="title">About Placement Pulse</h1>
      <p className="description">
        Welcome to <span className="highlight">Placement Pulse</span>, your
        ...
        <span className="highlight">Placement Pulse</span> is here to simplify
        the process.
      </p>
